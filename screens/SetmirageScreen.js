...
export default class SetmirageScreen extends React.Component {
  ...
  static navigationOptions = {
    ...
    state = {
      ...
      return (  
<View>
<Image source={require('../Assets/MarriageDateSkyBackground.png')}  style={{position:'absolute',width:Dimensions.get('window').width,height:428,borderBottomRightRadius:30,borderBottomLeftRadius:30}}/>
<Text style={{fontSize:24,color:'#735d78',fontWeight:'bold' ,textAlign:'right',marginRight:50,marginTop:109 }}>Date of{'\n'} Marriage</Text>
<View style={{justifyContent:'center',alignContent:'center',flexDirection:'row',width:Dimensions.get('window').width}}>
  ...
  <Text style={{position:'absolute',right:0,bottom:0,marginBottom:15,marginRight:25,fontSize:17,color:'#6b3064'}} onPress={() => this.sendSMS()}>Send </Text>
</View>
</View>
...
<Image source={require('../Assets/CalendarSignup.png')}  style={{width:80,height:80}}/>
      </View>
